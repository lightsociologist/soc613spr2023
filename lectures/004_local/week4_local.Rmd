...
For this tutorial we use igraph to observe local network characteristics within a whole graph. 
...
```{r}
source("scripts/mixmat.R")	# don’t forget the quotes! 
plot.igraph(valente, vertex.color=V(valente)$gender*2)
mixmat(valente, 'gender', use.density=F)	# the density option would provide proportional representation
```
