...
Let's add network configurations to this model. A list of ergm terms is located [here](https://cran.r-project.org/web/packages/ergm/vignettes/ergm-term-crossRef.html).
